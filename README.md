...
If deployment fails with missing system packages, keep packages.txt in the repo root (already included in this project) so Streamlit Cloud installs required Linux packages.
